                  ...
                  {user ? (
                    <>
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-3 py-3 text-sm font-medium rounded-md transition-all text-left text-white hover:opacity-90 active:opacity-80"
