 ...
 * - Fixed bottom CTA ONLY on Home page
...
export function CustomerLayout({ children }: CustomerLayoutProps) {
  ...
  // Only show fixed CTA on Home page
  const isHome = location.pathname === '/customer/home' || location.pathname === '/customer';

  return (
    <>
      <PageContainer variant="customer">
        <div className={isHome ? 'pb-24' : ''}>
          {children}
        </div>
      </PageContainer>

      {/* Fixed CTA ONLY on Home */}
      {isHome && (
